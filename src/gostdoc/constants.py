...
# --- Фаза 2: структурные элементы (ГОСТ 7.32-2017) ---
# Распознаются по ключевым словам; оформляются прописными, по центру, с новой страницы.
# Сравнение — по верхнему регистру после снятия лидеров/номера страницы.
...
# Структурные элементы, распознаваемые по префиксу (с номером/буквой).
STRUCT_PREFIXES = ("ПРИЛОЖЕНИЕ",)
